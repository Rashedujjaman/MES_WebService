...
- Create Angular project with ng: `ng new mes_webservice.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`mes_webservice.client.esproj`).
